                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                ...
                                Send a POST request to <code>/</code> 
                                to convert text to markdown.
                                </div>
                                
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <pre><code>curl localhost:8080 -d '# Hello World
...
2. Number two
'</code></pre></div>
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm"><b>Response:</b></div>
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm"><pre>&lt;h1&gt;Hello World&lt;/h1&gt;
